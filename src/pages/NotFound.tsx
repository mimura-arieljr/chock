        ...
        <div className="h-screen w-full bg-cover bg-center bg-no-repeat relative" style={{ backgroundImage: "url('/assets/404.gif')" }}>
            <div className="absolute inset-0 bg-opacity-50 flex items-center justify-center">
                <div className="flex flex-col items-center gap-y-10">
                    ...
                    >
                        <FuzzyText fontSize="clamp(2.75rem, 15vw, 8rem)" baseIntensity={0.2} hoverIntensity={0.7} enableHover={true}>
                            404
                        </FuzzyText>
                    </p>
                    <p
                    ...
                    >
                        <FuzzyText fontSize="clamp(1.75rem, 8vw, 4.5rem)" baseIntensity={0.2} hoverIntensity={0.7} enableHover={true}>
                            NOT FOUND
                        </FuzzyText>
                    </p>
                </div>
